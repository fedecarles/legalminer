        ...
        return this.each(function (instance) {
            ...
            var displayNav = function () {
                ...
                for (i = 0; i <= plugin.settings.pages - 1; i++) {
                    ...
                    if (plugin.settings.paginateContent != null) {
                        element = plugin.settings.paginateContent[i];
                    ...
                    if (plugin.settings.paginateClass != null) {
                        if (typeof plugin.settings.paginateClass === 'string') {
                            className = className.concat(plugin.settings.paginateClass);
                        } else if (Array.isArray(plugin.settings.paginateClass)) {
                            if (i >= plugin.settings.paginateClass.length) {
                                debugger;
                                className = className.concat(plugin.settings.paginateClass[i - plugin.settings.paginateClass.length]);
                            } else {
                                className = className.concat(plugin.settings.paginateClass[i]);
                            }
                        }
                    }

                    //htmlNav += '<li><a href="#' + plugin.settings.hashPage + ':' + j + '" title="Page ' + j + '" rel="' + j + '" class="' + className + '">' + element + '</a></li>';
                };
                ...
                if (plugin.settings.position == 'before') {
